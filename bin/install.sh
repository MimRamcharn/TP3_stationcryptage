...
then
	echo "Repository already clone to src folder."
else 
...
sudo cp -f ~/GSLW_TP3_stationcryptage/TP3_stationcryptage/TP3_stationcryptage/toCrypt/bin/crypt.service /etc/systemd/system/crypt.service
